...
layout(binding = COLOR_IMAGE_3D_BINDING, rgba8) writeonly uniform image3D tColor;
layout(binding = NORMAL_IMAGE_3D_BINDING, rgba32f) writeonly uniform image3D tNormal;
