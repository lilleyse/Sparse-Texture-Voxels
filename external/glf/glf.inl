...
*/
        ...
        switch(State)
        {
            case GLUT_DOWN:
            {
                switch(Button)
                {
                    ...
                    {
                        Window.LeftMouseDelta = glm::vec2(0.0f);
                        Window.MouseButtonFlags |= glf::MOUSE_BUTTON_LEFT;
                    }
                    break;
                    case GLUT_MIDDLE_BUTTON:
                    {
                        Window.MiddleMouseDelta = glm::vec2(0.0f);
                        Window.MouseButtonFlags |= glf::MOUSE_BUTTON_MIDDLE;
                    }
                    break;
                    case GLUT_RIGHT_BUTTON:
                    {
                        Window.RightMouseDelta = glm::vec2(0.0f);
    ...
    static void motion(int x, int y)
    {
        ...
        Window.LeftMouseDelta = Window.MouseButtonFlags & glf::MOUSE_BUTTON_LEFT ? MouseDelta : glm::vec2(0.0f);
        Window.MiddleMouseDelta = Window.MouseButtonFlags & glf::MOUSE_BUTTON_MIDDLE ? MouseDelta: glm::vec2(0.0f);
        Window.RightMouseDelta = Window.MouseButtonFlags & glf::MOUSE_BUTTON_RIGHT ? MouseDelta: glm::vec2(0.0f);
        mouseEvent();
    }
